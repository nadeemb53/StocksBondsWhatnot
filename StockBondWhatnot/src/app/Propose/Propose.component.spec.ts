...
describe('ProposeComponent', () => {
  ...
  let mockProposeService;
  let mockDataService

  beforeEach(async(() => {

    mockProposeService = sinon.createStubInstance(ProposeService);
    mockProposeService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: ProposeService, useValue: mockProposeService },
